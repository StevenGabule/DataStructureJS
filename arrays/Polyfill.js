...
In addition, since true iterables cannot be polyfilled, this implementation does not support
...
if (!Array.from) {
	Array.from = (function() {
		...
		return function from(arrayLike/*, mapFn, thisArg */) {
			// 1. let C be the value.
			var C = this;
			
			// 2. let item be ToObject(arrayLike).
        ...
        if (arguments.length > 2) {
			...
			// 10. Let lenValue to Get(items, "length")
